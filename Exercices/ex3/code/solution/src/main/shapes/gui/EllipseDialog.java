 ...
 * @author  fuhrer
 */
public class EllipseDialog extends javax.swing.JDialog {
    
    
    /**
	 * 
	 */
	private static final long serialVersionUID = 3256446888990618423L;
	private WorkShapes w;
    private Ellipse callingShape;
    
    /** Creates new form CircleDialog */
    public EllipseDialog(java.awt.Frame parent) {
        super(parent, true);
        w = (WorkShapes)parent;
        initComponents();
    }
    
    public EllipseDialog(Ellipse e) {
        super();
        setModal(true);
        callingShape = e;
        initComponents();
    ...
    private void initComponents() {//GEN-BEGIN:initComponents
        ...
        setTitle("Create/Edit an Ellipse");
        setResizable(false);
        ...
        jLabel4.setText("Enter Ellipse Data");
