...
/**
 * The <code>LinkedListStack</code> class represents a last-in-first-out (LIFO)
 * stack implemented with a linked list.
 *
 * @author Andreas Ruppen
 * @param <E> Type of <code>LinkedListStack</code> to represent.
 */
public class LinkedListStack<E> implements Dispenser<E> {
     ...
     * @throws dispenser.stack.EmptyStackException
     */
