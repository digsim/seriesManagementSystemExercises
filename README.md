...
http://digsim.homelinux.org/howtos/sms/sms.html
=============================================
...
[Config]
# name of the directory containing the series on moodle
moodleOutputDir: Handson
# remove the unzipped directory at the end (can be toggled with -k)
removeUnzipped: true
# bibtex web entries from nocite last visited time stamp will update (can be toggled with -u)
updateBibTex: true
# command for opening pdf file. Can be of style app,args
opencmd: open
...
[Lecture]
name: System II --- Telecommunications
lecturer: Prof. Dr. Ulrich Ultes-Nitsche \& Andreas Ruppen
year: SA 2008
# contains a list of bibtex keys which will always be cited
nocite: T03,WEBT
# this is the title of a serie
exercisetext: Hands-on
# how should the content section be named
contenttext: Content
# this is the title of the header
headertitle: Hands-on
# this is the name of the bibtex file
bibtex: bibdb.bib
...
[PDF]
pdfkeyword: System II --- Telecommunications
pdftitle: Hands-on
pdfauthor: Ulrich Ultes-Nitsche, Andreas Ruppen
